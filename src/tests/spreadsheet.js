...
fs.readFile('google-credentials.json', (err, content) => {
  ...
  authorize(JSON.parse(content), (auth) => {
    addNewGameToRow('Portal 3', 'valve', auth)
  });
});
 ...
 * @see https://docs.google.com/spreadsheets/d/1Qp8iwwlNHhoL6nxDuNC1r4OyDEWn98vZoTNMc1qwlv0/edit (game list)
...
function addNewGameToRow(game, name, auth) {
  const sheets = google.sheets({version: 'v4', auth});
